...
const PDFViewerApplication = {
  ...
  async download(options = {}) {
    ...
    try {
      ...
      var savingtxt = document.getElementById("savingtxt");
      savingtxt.style.display='block';
      savingtxt.innerHTML = 'Saving...';
      await axios.post(baseUrl+'/pdfview?file='+filesave, {
        file: file
      },{headers:headers})
      .then(function (response) {
        console.log(response);
        if(response.data.success)
          savingtxt.innerHTML = 'Saved';
        else
          savingtxt.innerHTML('Saving Failed');
      })
...
const defaultOptions = {
  ...
  workerSrc: {
    value: "./pdfviewer/build/pdf.worker.js?time="+filereq,
    kind: OptionKind.WORKER
  }
};
{
