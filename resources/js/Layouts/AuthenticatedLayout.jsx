                ...
                <div className="navbar-brand-box">
                    <a href="#" className="logo logo-dark">
                        <span className="logo-sm">
                            <img src="/assets/images/logo-sm.svg" alt="" className="md:w-16 md:h-16 sm:w-6 " />
                        </span>
                        <span className="logo-lg flex items-center justify-start">
                            <img src="/assets/images/logo-sm.svg" alt="" className="h-13 w-6" />{" "}
                ...
                <ul className="metismenu list-unstyled" id="side-menu">
                    ...
                    <>
                        ...
                        {permissions.includes('index_approver_invoice') ?
                            <li>
                                <a href={route( "approver-invoice.index" )}>
                                    <Shuffle />
                        ...
                        {permissions.includes('index_approver_payment') ?
                            <li>
                                <a href={route( "approver-payment.index" )}>
                                    <Shuffle />
