            ...
            <div className="pt-6">
                <div className="">
                    <div className="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                        <div className="p-6 text-gray-900 font-bold">Tax</div>
                    </div>
                </div>
            </div>

            {props.data.permissions.includes('store_tax') ?
            ...
            <div className="pt-3">
                <div className="">
                    <div className="bg-white overflow-hidden shadow-lg sm:rounded-lg p-6">
                        <p className="font-bold mb-3">List Tax</p>
                        <Table data={props.data.taxes} routeEdit="tax.edit" permissions={props.data.permissions} />
                    </div>
                </div>
            </div>
