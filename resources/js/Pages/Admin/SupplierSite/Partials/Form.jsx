...
export default function Form(props) {
    const { data, setData, put, post, processing, errors, recentlySuccessful, reset } = useForm({
        name: props.title === 'Edit' ? props.data.supplier_site.name : '',
    ...
    const submit = (e) => {
        ...
        if (props.title == 'Tambah') {
            post(route('admin.supplier-site.store'));
        } else {
            put(route('admin.supplier-site.update', props.id));
        }
    };
            ...
            <form onSubmit={submit}>
                <div className="mb-3">
                    ...
                    <TextInput
                        ...
                        autoComplete="name"
                        placeholder="Supplier SIte Name"
                        isFocused={true}
