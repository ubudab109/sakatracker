...
export default function Edit({ auth, mustVerifyEmail, status, ...props }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Approver Invoice</h2>}
        >
            ...
            <Form data={props.data} route='approver-invoice.update' id={props.data.approver.id} message="Successfully to updated approver invoice." title="Edit" auth={auth} />
        </AuthenticatedLayout>
    );
}
