...
export default function Edit({ auth, mustVerifyEmail, status, ...props }) {
    ...
    return (
        ...
        >
            ...
            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                        <li className="breadcrumb-item"><a href={route('admin.request-good-receipt.index')}>Request GR</a></li>
            ...
            <Form data={props.data} route='admin.request-good-receipt.update' id={props.data.request_good_receipt.id} message="Successfully to updated Request GR." title="Edit" auth={auth} />
        </AuthenticatedLayout>
    );
}
