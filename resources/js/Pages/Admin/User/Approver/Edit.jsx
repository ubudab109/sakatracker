...
export default function Edit({ auth, mustVerifyEmail, status, ...props }) {
    ...
    return (
        ...
        >
            ...
            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                        ...
                        <li className="breadcrumb-item active">Edit Approver</li>
                    </ol>
                </div>
            </div>
            ...
            <Form data={props.data} route='approver.update' id={props.data.id} message="Successfully to updated approver." title="Edit" auth={auth} />
        </AuthenticatedLayout>
    );
}
