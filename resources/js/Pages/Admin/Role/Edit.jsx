            ...
            <div className="pt-6">
                <div className="">
                    <div className="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                        <div className="p-6 text-gray-900 font-bold">Edit Role</div>
                    </div>
                </div>
            </div>

            
            <Form data={props.data} route='role.update' id={props.data.role.id} message="Successfully to updated role." title="Edit" auth={auth} />
        </AuthenticatedLayout>
    );
}
