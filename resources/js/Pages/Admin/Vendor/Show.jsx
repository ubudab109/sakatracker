                                    ...
                                    <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 border-dashed border-b-2 border-gray-300 p-1">
                                        ...
                                        <div className="border-dashed border-gray-300 text-sm text-gray-500">
                                            ...
                                            <p className="mb-3 flex justify-between">
                                                :
                                                <a href={props.data.vendor.file_npwp} target='_blank'><File></File></a>
                                            ...
                                            <p className="mb-3 flex justify-between">
                                                :
                                                <a href={props.data.vendor.file_sppkp} target='_blank'><File></File></a>
                                            ...
                                            <p className="mb-3 flex justify-between">
                                                :
                                                <a href={props.data.vendor.file_siup} target='_blank'><File></File></a>
                                            ...
                                            <p className="mb-3 flex justify-between">
                                                :
                                                <a href={props.data.vendor.file_tdp} target='_blank'><File></File></a>
                                            ...
                                            <p className="mb-3 flex justify-between">
                                                :
                                                <a href={props.data.vendor.file_nib} target='_blank'><File></File></a>
                                        ...
                                        <div className="lg:ml-5 text-sm text-gray-500">
                                            ...
                                            <p className="mb-3 flex justify-between">
                                                :
                                                <a href={props.data.vendor.file_board_of_directors_composition} target='_blank'><File></File></a>
                                                {props.data.vendor
                                ...
                                <div className="mb-3">
                                    <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 border-dashed border-b-2 border-gray-300 p-1">
                                        ...
                                        <p className='mb-3 flex justify-between'>:
                                            ...
                                            <p className="mb-3 flex justify-between">
                                                :
                                                <a href={props.data.vendor.file_non_pkp_statement} target='_blank'><File></File></a>
                                                {props.data.vendor
