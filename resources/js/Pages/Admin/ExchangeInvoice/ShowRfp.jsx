...
export default function Index(props) {
    ...
    const [showOptionApproverInvoice, setShowOptionApproverInvoice] = useState(false);
        ...
        >
            ...
            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                        ...
                        <li className="breadcrumb-item active"><a href={route('admin.exchange-invoice.show', props.data.invoice.id)}>Detail Tukar Faktur</a></li>
                        <li className="breadcrumb-item active">Show RFP</li>
                    </ol>
                </div>
            </div>
            ...
            <div className="pt-6">
                <div className="flex items-center gap-2">
                    <a href={route('admin.exchange-invoice.show', props.data.invoice.id)}><ArrowLeft /></a>
                    <div className="bg-white overflow-hidden shadow-lg sm:rounded-lg w-full">
                        <div className="p-6 text-gray-900 font-bold">Show RFP</div>
                    </div>
                </div>
            </div>
                ...
                <div className="">
                    <div className="bg-white overflow-hidden shadow-lg sm:rounded-lg p-6">
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2'>
                                    ...
                                    <div className='mb-3'>
                                        <div className='flex justify-center font-bold'>
                                            <div className='grid grid-cols-2 gap-3 text-center items-center w-full'>
                        ...
                        <div className="flex justify-end items-end gap-2 mt-2">
                            <Link href={route('admin.exchange-invoice.show', props.data.invoice.id)}>
                                <SecondaryButton>
                                    Back
                                </SecondaryButton>
                            </Link>
