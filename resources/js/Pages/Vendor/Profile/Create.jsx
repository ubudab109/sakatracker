...
export default function Create(props) {
	...
	const {
		...
		email:
			props.data.vendor.user.email != null
				? props.data.vendor.user.email
				: "",
		npwp: props.data.vendor.npwp != null ? props.data.vendor.npwp : "",
		name_business:
			props.data.vendor.name_business != null
				? props.data.vendor.name_business
				: "",
		office_address:
			props.data.vendor.office_address != null
				? props.data.vendor.office_address
				: "",
		npwp_address:
			props.data.vendor.npwp_address != null
				? props.data.vendor.npwp_address
				: "",
		country_id:
			props.data.vendor.country_id != null
				? props.data.vendor.country_id
				: "",
		country:
			props.data.vendor.country != null ? props.data.vendor.country : "",
		province_id:
			props.data.vendor.province_id != null
				? props.data.vendor.province_id
				: "",
		province_name:
			props.data.vendor.province_name != null
				? props.data.vendor.province_name
				: "",
		city_id:
			props.data.vendor.city_id != null ? props.data.vendor.city_id : "",
		city_name:
			props.data.vendor.city_name != null
				? props.data.vendor.city_name
				: "",
		postal_code:
			props.data.vendor.postal_code != null
				? props.data.vendor.postal_code
				: "",
		phone_number:
			props.data.vendor.phone_number != null
				? props.data.vendor.phone_number
				: "",
		mobile_phone_number:
			props.data.vendor.mobile_phone_number != null
				? props.data.vendor.mobile_phone_number
				: "",
		type_of_business:
			props.data.vendor.type_of_business != null
				? props.data.vendor.type_of_business
				: "",
		director_name:
			props.data.vendor.director_name != null
				? props.data.vendor.director_name
				: "",
		director_phone_number:
			props.data.vendor.director_phone_number != null
				? props.data.vendor.director_phone_number
				: "",
		director_email:
			props.data.vendor.director_email != null
				? props.data.vendor.director_email
				: "",
		marketing_key_account:
			props.data.vendor.marketing_key_account != null
				? props.data.vendor.marketing_key_account
				: "",
		marketing_phone_number:
			props.data.vendor.marketing_phone_number != null
				? props.data.vendor.marketing_phone_number
				: "",
		marketing_email:
			props.data.vendor.marketing_email != null
				? props.data.vendor.marketing_email
				: "",
		fa_name:
			props.data.vendor.fa_name != null ? props.data.vendor.fa_name : "",
		fa_phone_number:
			props.data.vendor.fa_phone_number != null
				? props.data.vendor.fa_phone_number
				: "",
		fa_email:
			props.data.vendor.fa_email != null
				? props.data.vendor.fa_email
				: "",
		is_bca:
			props.data.vendor.is_bca != null ? props.data.vendor.is_bca : "",
		bank_name:
			props.data.vendor.bank_name != null
				? props.data.vendor.bank_name
				: "",
		is_virtual_account:
			props.data.vendor.is_virtual_account != null
				? props.data.vendor.is_virtual_account
				: "",
		bank_account_name:
			props.data.vendor.bank_account_name != null
				? props.data.vendor.bank_account_name
				: "",
		bank_account_number:
			props.data.vendor.bank_account_number != null
				? props.data.vendor.bank_account_number
				: "",
		branch_of_bank:
			props.data.vendor.branch_of_bank != null
				? props.data.vendor.branch_of_bank
				: "",
		bank_swift_code:
			props.data.vendor.bank_swift_code != null
				? props.data.vendor.bank_swift_code
				: "",
		file_npwp:
			props.data.vendor.file_npwp != null
				? props.data.vendor.file_npwp
				: "",
		expired_npwp:
			props.data.vendor.expired_npwp != null
				? props.data.vendor.expired_npwp
				: "",
		file_sppkp:
			props.data.vendor.file_sppkp != null
				? props.data.vendor.file_sppkp
				: "",
		expired_sppkp:
			props.data.vendor.expired_sppkp != null
				? props.data.vendor.expired_sppkp
				: "",
		file_siup:
			props.data.vendor.file_siup != null
				? props.data.vendor.file_siup
				: "",
		expired_siup:
			props.data.vendor.expired_siup != null
				? props.data.vendor.expired_siup
				: "",
		file_tdp:
			props.data.vendor.file_tdp != null
				? props.data.vendor.file_tdp
				: "",
		expired_tdp:
			props.data.vendor.expired_tdp != null
				? props.data.vendor.expired_tdp
				: "",
		file_nib:
			props.data.vendor.file_nib != null
				? props.data.vendor.file_nib
				: "",
		expired_nib:
			props.data.vendor.expired_nib != null
				? props.data.vendor.expired_nib
				: "",
		file_board_of_directors_composition:
			props.data.vendor.file_board_of_directors_composition != null
				? props.data.vendor.file_board_of_directors_composition
				: "",
		file_front_page_bank:
			props.data.vendor.file_front_page_bank != null
				? props.data.vendor.file_front_page_bank
				: "",
		file_bank_account_statement_letter:
			props.data.vendor.file_bank_account_statement_letter != null
				? props.data.vendor.file_bank_account_statement_letter
				: "",
		file_non_pkp_statement:
			props.data.vendor.file_non_pkp_statement != null
				? props.data.vendor.file_non_pkp_statement
				: "",
		file_ektp:
			props.data.vendor.file_ektp != null
				? props.data.vendor.file_ektp
				: "",
		expired_ektp:
			props.data.vendor.expired_ektp != null
				? props.data.vendor.expired_ektp
				: "",
		legality:
			props.data.vendor.legality != null
				? props.data.vendor.legality
				: "",
		suffix:
			props.data.vendor.suffix != null ? props.data.vendor.suffix : "",
		term_condition: "",
		status_submit: "",
		attachment: [],
	});
	...
	const [selectedOptionCity, setSelectedOptionCity] = useState(
		props.data.vendor.city_id
	);
	const [provinces, setProvinces] = useState([]);
	const [cities, setCities] = useState([]);
	const [selectedBankBca, setSelectedBankBca] = useState(
		props.data.vendor.is_bca != null
			? props.data.vendor.is_bca == "1"
				? "1"
				: "0"
			: "0"
	);
	const [selectedVirtualBank, setSelectedVirtualBank] = useState(
		props.data.vendor.is_virtual_account != null
			? props.data.vendor.is_virtual_account == "1"
				? "1"
				: "0"
			: "0"
	);
	...
	const [tabPkp, setTabPkp] = useState(
		data.type_of_business == "PKP" ? "" : "hidden"
	);
	const [tabNonPkp, setTabNonPkp] = useState(
		data.type_of_business == "Non PKP" ? "" : "hidden"
	);
	const [tabPribadi, setTabPribadi] = useState(
		data.type_of_business == "Pribadi" ? "" : "hidden"
	);

	const [radioOptionType, setSelectedOption] = useState(
	...
	const handleRadioChange = (event) => {
		...
		data.type_of_business == "Non PKP"
			? setTabNonPkp("")
			: setTabNonPkp("hidden");
		data.type_of_business == "Pribadi"
			? setTabPribadi("")
			: setTabPribadi("hidden");
	};
	...
	const [npwpFile, setNpwpFile] = useState(
		props.data.vendor.file_npwp == null
			? "No file chosen"
			: props.data.vendor.file_npwp_name
	);
	const [sppkpFile, setSppkpFile] = useState(
		props.data.vendor.file_sppkp == null
			? "No file chosen"
			: props.data.vendor.file_sppkp_name
	);
	const [siupFile, setSiupFile] = useState(
		props.data.vendor.file_siup == null
			? "No file chosen"
			: props.data.vendor.file_siup_name
	);
	const [tdpFile, setTdpFile] = useState(
		props.data.vendor.file_tdp == null
			? "No file chosen"
			: props.data.vendor.file_tdp_name
	);
	const [nibFile, setNibFile] = useState(
		props.data.vendor.file_nib == null
			? "No file chosen"
			: props.data.vendor.file_nib_name
	);
	const [bodcFile, setBodcFile] = useState(
		props.data.vendor.file_board_of_directors_composition == null
			? "No file chosen"
			: props.data.vendor.file_board_of_directors_composition_name
	);
	const [nonPkpFile, setNonPkpFile] = useState(
		props.data.vendor.file_non_pkp_statement == null
			? "No file chosen"
			: props.data.vendor.file_non_pkp_statement_name
	);
	...
	const [showBankName, setShowBankName] = useState(
		props.data.vendor.is_bca == 1 ? true : false
	);
	...
	const [npwp, setNPWP] = useState(
		props.data.vendor.npwp != null ? props.data.vendor.npwp : ""
	);
	...
	const [selectedOptionLegality, setSelectedOptionLegality] = useState(
		props.data.vendor.legality ? props.data.vendor.legality : ""
	);
	...
	const [selectedOptionSuffix, setSelectedOptionSuffix] = useState(
		props.data.vendor.suffix ? props.data.vendor.suffix : ""
	);
			...
			<div className="page-title-box d-sm-flex align-items-center justify-content-between">
				...
				<div className="page-title-right">
					<ol className="breadcrumb m-0">
						...
						<li className="breadcrumb-item">
							<a href={route("vendor.index")}>Perubahan Data</a>
						</li>
					...
					<form onSubmit={submit}>
							...
							<div className="grid grid-cols-2">
								...
								<div className="ml-5">
									<div className="">
										...
										<InputError
											message={errors.type_of_business}
											className="mt-2"
										/>
							...
							<div className="grid grid-cols-2">
								<div>
									...
									<div className="mb-3">
										...
										<InputError
											message={errors.mobile_phone_number}
											className="mt-2"
										/>
									</div>
								</div>
						...
						>
							<div className="grid grid-cols-2">
								...
								<div className="w-full ml-5 mb-3">
									...
									<InputError
										message={errors.is_virtual_account}
										className="mt-2"
									/>
								</div>
						...
						>
							<div className={`${tabPkp}`}>
								<p className="font-bold mb-3">
									Type of Business: Wajib Pajak Badan Usaha -
									PKP
								</p>
								<div className="grid grid-cols-1 md:grid-cols-2">
									<div>
										...
										<div className="mb-3">
											...
											<InputError
												message={
													errors.file_board_of_directors_composition
												}
												className="mt-2"
											/>
										</div>
							...
							<div className={`${tabNonPkp}`}>
								...
								<div className="grid grid-cols-1 md:grid-cols-2">
									<div>
										...
										<div className="mb-3">
											<InputLabel
												value="Surat Pernyataan Non PKP (Bermaterai)"
												className="font-bold"
												required={true}
											/>
											<div className="flex">
												<label
													htmlFor="file-non-kpk"
													className="border-1 p-3 rounded-s-lg w-15 m-0 text-white bg-slate-800"
												>
													CHOOSE FILE
												</label>
							...
							<div className={`${tabPribadi}`}>
								<p className="font-bold mb-3">
									Type of Business: Wajib Pajak Pribadi
								</p>
								<div className="grid grid-cols-1 md:grid-cols-2">
									<div>
										<div className="mb-3">
						...
						>
							<div>
								...
								>
									<li className="mb-1">
										Formulir Pendaftaran Pemasok Baru diisi
										sebagai syarat pemasok akan menjadi
										pemasok tetap Kalbe Consumer Health.
									</li>
									<li className="mb-1">
										Pemasok akan didaftarkan dalam sistem
										Kalbe Consumer Health setelah terjadi
										minimal 3 ( tiga) transaksi penjualan ke
										Kalbe Consumer Health, mengisi formulir
										Pendaftaran Pemasok Baru dengan baik dan
										benar, dan melampirkan dokumen pendukung
										yang disyaratkan.
									</li>
									<li className="mb-1">
										Tanggal Term of Payment berdasarkan
										tanggal terima invoice oleh bagian Tukar
										Faktur yang sudah diverifikasi dengan
										baik dan benar.
									</li>
									<li className="mb-1">
										Jangka waktu pembayaran sesuai dengan
										Term of Payment yang telah disepakati
										kedua belah pihak.
									</li>
									<li className="mb-1">
										Apabila terjadi koreksi tagihan maka
										pembayaran akan dihitung setelah tagihan
										tagihan diterima dengan baik dan benar.
									</li>
									<li className="mb-1">
										Pemasok dan Kalbe Consumer Health
										sepakat untuk menaati ketentuan dan
										peraturan yang berlaku terkait Etika
										Bisnis, baik selama maupun setelah
										berakhirnya kerjasama ini. Masing-masing
										Pihak melarang tenaga kerjanya melakukan
										persekongkolan yang termasuk tetapi
										tidak terbatas pada: penggelapan,
										penipuan, penyuapan baik dalam bentuk
										uang atau dalam bentuk lain, pemberian
										komisi, pemberian janji apapun kepada
										salah satu pihak dan/atau tindakan lain
										...
										terutama bagi salah satu Pihak dalam
										kerjasama. Serta berusaha semaksimal
										mungkin agar tenaga kerja masing-masing
										Pihak yang terkait dengan pelaksanaan
										kerjasama ini tidak terlibat dalam
										persekongkolan.
									</li>
									<li className="mb-1">
										Apabila ada indikasi maupun bukti
										terjadinya persekongkolan sebagaimana
										dimaksud dalam point 6, maka Para Pihak
										sepakat untuk mengambil tindakan tegas
										sesegera mungkin untuk memutuskan
										hubungan kerja dengan tenaga kerja
										tersebut, dan pihak yang dirugikan dapat
										mengambil tindakan hukum yang dianggap
										perlu, termasuk melaporkan kepada pihak
										Kepolisian dan/atau melakukan gugatan
										perdata dan/atau pidana terkait kerugian
										yang timbul.
									</li>
								</ol>
								<div className="">
