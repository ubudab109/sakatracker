...
export default function Create(props) {
    ...
    const { data, hasErrors, clearErrors, setData, post, processing, errors, recentlySuccessful, setError, reset } = useForm({
        name: props.data.vendor != null ? props.data.vendor.name : '',
        email: props.data.vendor != null ? props.data.vendor.user.email : '',
        npwp: props.data.vendor != null ? props.data.vendor.npwp : '',
        name_business: props.data.vendor != null ? props.data.vendor.name_business : '',
        office_address: props.data.vendor != null ? props.data.vendor.office_address : '',
        npwp_address: props.data.vendor != null ? props.data.vendor.npwp_address : '',
        country_id: props.data.vendor != null ? props.data.vendor.country_id : '',
        country: props.data.vendor != null ? props.data.vendor.country : '',
        province_id: props.data.vendor != null ? props.data.vendor.province_id : '',
        province_name: props.data.vendor != null ? props.data.vendor.province_name : '',
        city_id: props.data.vendor != null ? props.data.vendor.city_id : '',
        city_name: props.data.vendor != null ? props.data.vendor.city_name : '',
        postal_code: props.data.vendor != null ? props.data.vendor.postal_code : '',
        phone_number: props.data.vendor != null ? props.data.vendor.phone_number : '',
        mobile_phone_number: props.data.vendor != null ? props.data.vendor.mobile_phone_number : '',
        type_of_business: props.data.vendor != null ? props.data.vendor.type_of_business : 'Pribadi',
        director_name: props.data.vendor != null ? props.data.vendor.director_name : '',
        director_phone_number: props.data.vendor != null ? props.data.vendor.director_phone_number : '',
        director_email: props.data.vendor != null ? props.data.vendor.director_email : '',
        marketing_key_account: props.data.vendor != null ? props.data.vendor.marketing_key_account : '',
        marketing_phone_number: props.data.vendor != null ? props.data.vendor.marketing_phone_number : '',
        marketing_email: props.data.vendor != null ? props.data.vendor.marketing_email : '',
        fa_name: props.data.vendor != null ? props.data.vendor.fa_name : '',
        fa_phone_number: props.data.vendor != null ? props.data.vendor.fa_phone_number : '',
        fa_email: props.data.vendor != null ? props.data.vendor.fa_email : '',
        is_bca: props.data.vendor != null ? props.data.vendor.is_bca : '',
        bank_name: props.data.vendor != null ? props.data.vendor.bank_name : '',
        is_virtual_account: props.data.vendor != null ? props.data.vendor.is_virtual_account : '',
        bank_account_name: props.data.vendor != null ? props.data.vendor.bank_account_name : '',
        bank_account_number: props.data.vendor != null ? props.data.vendor.bank_account_number : '',
        branch_of_bank: props.data.vendor != null ? props.data.vendor.branch_of_bank : '',
        bank_swift_code: props.data.vendor != null ? props.data.vendor.bank_swift_code : '',
        file_npwp: props.data.vendor != null ? props.data.vendor.file_npwp : '',
        expired_npwp: props.data.vendor != null ? props.data.vendor.expired_npwp : '',
        file_sppkp: props.data.vendor != null ? props.data.vendor.file_sppkp : '',
        expired_sppkp: props.data.vendor != null ? props.data.vendor.expired_sppkp : '',
        file_siup: props.data.vendor != null ? props.data.vendor.file_siup : '',
        expired_siup: props.data.vendor != null ? props.data.vendor.expired_siup : '',
        file_tdp: props.data.vendor != null ? props.data.vendor.file_tdp : '',
        expired_tdp: props.data.vendor != null ? props.data.vendor.expired_tdp : '',
        file_nib: props.data.vendor != null ? props.data.vendor.file_nib : '',
        expired_nib: props.data.vendor != null ? props.data.vendor.expired_nib : '',
        file_board_of_directors_composition: props.data.vendor != null ? props.data.vendor.file_board_of_directors_composition : '',
        file_front_page_bank: props.data.vendor != null ? props.data.vendor.file_front_page_bank : '',
        file_bank_account_statement_letter: props.data.vendor != null ? props.data.vendor.file_bank_account_statement_letter : '',
        file_non_pkp_statement: props.data.vendor != null ? props.data.vendor.file_non_pkp_statement : '',
        file_ektp: props.data.vendor != null ? props.data.vendor.file_ektp : '',
        expired_ektp: props.data.vendor != null ? props.data.vendor.expired_ektp : '',
        legality: props.data.vendor != null ? props.data.vendor.legality : '',
    ...
    const [selectedOptionCountry, setSelectedOptionCountry] = useState(props.data.vendor ? props.data.vendor.country_id : 102);
    const [selectedOptionProvince, setSelectedOptionProvince] = useState(props.data.vendor ? props.data.vendor.province_id : '');
    const [selectedOptionCity, setSelectedOptionCity] = useState(props.data.vendor ? props.data.vendor.city_id : '');
    const [provinces, setProvinces] = useState([]);
    const [cities, setCities] = useState([]);
    const [selectedBankBca, setSelectedBankBca] = useState(props.data.vendor ? props.data.vendor.is_bca != null ? props.data.vendor.is_bca == '1' ? '1' : '0' : '0' : '0');
    const [selectedVirtualBank, setSelectedVirtualBank] = useState(props.data.vendor ? props.data.vendor.is_virtual_account != null ? props.data.vendor.is_virtual_account == '1' ? '1' : '0' : '0' : '0');
    ...
    const [npwpFile, setNpwpFile] = useState(props.data.vendor ? props.data.vendor.file_npwp == null ? "No file chosen" : props.data.vendor.file_npwp_name : 'No file choosen');
    const [sppkpFile, setSppkpFile] = useState(props.data.vendor ? props.data.vendor.file_sppkp == null ? "No file chosen" : props.data.vendor.file_sppkp_name : 'No file choosen');
    const [siupFile, setSiupFile] = useState(props.data.vendor ? props.data.vendor.file_siup == null ? "No file chosen" : props.data.vendor.file_siup_name : 'No file choosen');
    const [tdpFile, setTdpFile] = useState(props.data.vendor ? props.data.vendor.file_tdp == null ? "No file chosen" : props.data.vendor.file_tdp_name : 'No file choosen');
    const [nibFile, setNibFile] = useState(props.data.vendor ? props.data.vendor.file_nib == null ? "No file chosen" : props.data.vendor.file_nib_name : 'No file choosen');
    const [bodcFile, setBodcFile] = useState(props.data.vendor ? props.data.vendor.file_board_of_directors_composition == null ? "No file chosen" : props.data.vendor.file_board_of_directors_composition_name : 'No file choosen');
    const [nonPkpFile, setNonPkpFile] = useState(props.data.vendor ? props.data.vendor.file_non_pkp_statement == null ? "No file chosen" : props.data.vendor.file_non_pkp_statement_name : 'No file choosen');
    ...
    const [showBankName, setShowBankName] = useState(props.data.vendor ? props.data.vendor.is_bca == 1 ? true : false : false);
    ...
    const [npwp, setNPWP] = useState(props.data.vendor ? props.data.vendor.npwp != null ? props.data.vendor.npwp : '' : '');
    ...
    const [selectedOptionLegality, setSelectedOptionLegality] = useState(props.data.vendor ? props.data.vendor.legality ? props.data.vendor.legality : '' : '');
    ...
    const [selectedOptionSuffix, setSelectedOptionSuffix] = useState(props.data.vendor ? props.data.vendor.suffix ? props.data.vendor.suffix : '' : '');
            ...
            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                        ...
                        <li className="breadcrumb-item active">Submission of Change Data</li>
                    </ol>
                </div>
            </div>
