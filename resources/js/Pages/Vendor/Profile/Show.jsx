							...
							{props.data.vendor.type_of_business == 'PKP' ? <div className='mb-3'>
								<div className='grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 border-dashed border-b-2 border-gray-300 p-1'>
									<div className='grid grid-cols-2'>
										<div className='border-l-0'>
											<p className="font-bold text-black mb-4">Business Information</p>
											...
											<p className={`text-sm text-${props.data.vendor.status_account == 'ditolak' ? props.data.vendor.sppkp_note != 'acc' ? 'red' : 'gray' : 'gray'}-500`} style={{ marginBottom: '34px' }}>SPPKP</p>

											{
												props.data.vendor.company_document_type ?
													(
														props.data.vendor.company_document_type === 'siup' ? (
											...
											<p className={`text-sm text-gray-500 mb-4`}>Others</p>
