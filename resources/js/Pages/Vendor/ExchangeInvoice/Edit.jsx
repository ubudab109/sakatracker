...
export default function Create({ auth, status, ...props }) {
    return (
        <AuthenticatedLayout
            user={auth.user}
        >
            <Head title="Edit Invoice Exchange" />
            ...
            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                        ...
                        <li className="breadcrumb-item active">Edit Invoice Exchange</li>
                    </ol>
                </div>
            </div>
            ...
            <div className="pt-6">
                <div className="">
                    <div className="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                        <div className="p-6 text-gray-900 font-bold">Edit Invoice Exchange</div>
                    </div>
                </div>
            </div>
