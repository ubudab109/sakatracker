...
<link rel="resource" type="application/l10n" href="{{url('/')}}/pdfviewer/web/locale/locale.properties">
<script>var filereq = '{{$file}}?v={{time()}}';var filesave = '{{$filesave}}';var baseUrl = '{{url('/')}}';</script>
<script src="{{url('/')}}/pdfviewer/build/pdf.js?v={{time()}}"></script>

    <link rel="stylesheet" href="{{url('/')}}/pdfviewer/web/viewer.css">
    <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
  <script src="{{url('/')}}/pdfviewer/web/viewer.js?v={{time()}}"></script>
  </head>
      ...
      <div id="mainContainer">
        ...
        <div class="toolbar">
          <div id="toolbarContainer">
            ...
            <i id="savingtxt" style="display:none;float:right;color:white;">Saved...</i>
            <div id="loadingBar">
              <div class="progress">
                <div class="glimmer">
                </div>
