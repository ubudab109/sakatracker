...
class VendorReportController extends Controller
{
    ...
    // private function revisionVendor()
    // {
    //     $data['revisionApproved'] = Vendor::where('user_id', Auth::user()->id)->where('status_account', 'disetujui')->count();
    //     $data['revisionRejected'] = Vendor::where('user_id', Auth::user()->id)->where('status_account', 'ditolak')->count();
    //     $data['revisionProgress'] = Vendor::where('user_id', Auth::user()->id)->where('status_account', 'pengajuan perubahan')->count();
